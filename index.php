  ...
  <body background="<?php echo $bg_img; ?>">
    <div class="container <?php echo $materialize_text_color; ?>-text">
      <div class="section">
        <div class="row">
          <div class="col s6">
            <div class="card-panel hoverable <?php echo $materialize_card_color; ?> waves-block waves-light bigEntrance">
              <h4 class="center-align bigEntrance">Au1st3in's Garry's Mod Server<h4><br>
            ...
            <div class="card-panel hoverable <?php echo $materialize_card_color; ?> waves-effect waves-block waves-light bigEntrance">
              ...
              <ol class="bigEntrance" style="font-size:18px" type="1">
                  <li>Don't mess with other Players. [<i>Ex. Killing or Deleting Props</i>]</li>
          ...
          <div class="col s6">
            <div class="card-panel hoverable <?php echo $materialize_card_color; ?> waves-effect waves-block waves-light bigEntrance">
              ...
              <h3 class="center-align bigEntrance">Welcome back, <?php echo $username; ?>!</h3>
            ...
            <div class="card-panel hoverable <?php echo $materialize_card_color; ?> waves-effect waves-block waves-light bigEntrance">
              <div class="valign-wrapper">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn-floating btn-large waves-effect waves-light teal darken-4 tooltipped bigEntrance" data-position="bottom" data-delay="50" data-tooltip="Workshop Content" href="http://steamcommunity.com/sharedfiles/filedetails/?id=<?php echo $SteamWorkshopid; ?>"><i class="material-icons">library_add</i>Workshop Content</a>
